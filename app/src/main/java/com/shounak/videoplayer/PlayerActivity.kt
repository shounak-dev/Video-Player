...
import com.shounak.videoplayer.databinding.ActivityPlayerBinding
import com.shounak.videoplayer.databinding.BoosterBinding
import com.shounak.videoplayer.databinding.MoreFeaturesBinding
import com.shounak.videoplayer.databinding.SpeedDialogBinding
import java.io.File
...
class PlayerActivity : AppCompatActivity(), AudioManager.OnAudioFocusChangeListener, GestureDetector.OnGestureListener {
    ...
    private fun initializeBinding() {
        ...
        //for Change of Screen Orientation
        ...
        findViewById<ImageButton>(R.id.rewindBtn).setOnClickListener {
            player.seekTo(player.currentPosition - 10000)
        }
        findViewById<ImageButton>(R.id.forwardBtn).setOnClickListener {
            player.seekTo(player.currentPosition + 10000)
        }
        findViewById<ImageButton>(R.id.captureBtn).setOnClickListener{
            val bitmap = getScreenShotFromView(playerView)
            if (bitmap != null) {
    ...
    override fun onScroll(event: MotionEvent?, event1: MotionEvent?, distanceX: Float, distanceY: Float): Boolean {
        ...
        val border = 70 * Resources.getSystem().displayMetrics.density.toInt()
